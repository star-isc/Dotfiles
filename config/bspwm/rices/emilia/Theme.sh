...
launch_bars() {
		...
		polybar -q emi-bar2 -c ${rice_dir}/config.ini &
		polybar -q emi-bar3 -c ${rice_dir}/config.ini &
		polybar -q emi-bar4 -c ${rice_dir}/config.ini &
		polybar -q emi-bar5 -c ${rice_dir}/config.ini &
}
